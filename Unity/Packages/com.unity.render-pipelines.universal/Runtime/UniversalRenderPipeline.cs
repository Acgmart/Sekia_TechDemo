...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        internal static bool CheckPostProcessForDepth(ref CameraData cameraData)
        {
        ...
        internal static bool CheckPostProcessForDepth()
        {
        ...
        internal static void SetSupportedRenderingFeatures()
        {
#if UNITY_EDITOR
            SupportedRenderingFeatures.active = new SupportedRenderingFeatures()
            {
