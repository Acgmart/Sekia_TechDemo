...
#pragma warning restore 0618
    ...
    public sealed partial class UniversalRenderPipeline
    {
        ...
        internal static List<Vector4> m_ShadowBiasData = new List<Vector4>();
        internal static List<int> m_ShadowResolutionData = new List<int>();
        ...
        static Comparison<Camera> cameraComparison = (camera1, camera2) => { return (int)camera1.depth - (int)camera2.depth; };
#if UNITY_2021_1_OR_NEWER
        internal static void SortCameras(List<Camera> cameras)
        {
            if (cameras.Count > 1)
...
#else
        internal static void SortCameras(Camera[] cameras)
        {
            if (cameras.Length > 1)
        ...
        internal static Lightmapping.RequestLightsDelegate lightsDelegate = (Light[] requests, NativeArray<LightDataGI> lightsOutput) =>
        {
