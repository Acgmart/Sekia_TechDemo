...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class DeferredLights
    {
        ...
        public static readonly string[] k_StencilDeferredPassNames = new string[]
         {
            "Stencil Volume",
        ...
        public static readonly ushort k_InvalidLightOffset = 0xFFFF;
        public static readonly string k_SetupLights = "SetupLights";
        public static readonly string k_DeferredPass = "Deferred Pass";
        public static readonly string k_DeferredStencilPass = "Deferred Shading (Stencil)";
        static readonly string k_DeferredFogPass = "Deferred Fog";
        static readonly string k_ClearStencilPartial = "Clear Stencil Partial";
        public static readonly string k_SetupLightConstants = "Setup Light Constants";
        public static readonly float kStencilShapeGuard = 1.06067f; // stencil geometric shapes must be inflated to fit the analytic shapes.
        private static readonly ProfilingSampler m_ProfilingSetupLights = new ProfilingSampler(k_SetupLights);
        public static readonly ProfilingSampler m_ProfilingDeferredPass = new ProfilingSampler(k_DeferredPass);
        public static readonly ProfilingSampler m_ProfilingSetupLightConstants = new ProfilingSampler(k_SetupLightConstants);
