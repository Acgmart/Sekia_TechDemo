...
using TextureResources = UnityEngine.Rendering.Universal.UniversalRenderPipelineAsset.TextureResources;
...
namespace Sekia
{
    ...
    public class SekiaPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        public class PipelineResources
        {
            ...
            public StencilStateData m_DefaultStencilState = new StencilStateData() { passOperation = StencilOp.Replace };
        }
        ...
        //新增的用于直接访问的字段
        [SerializeField] public bool m_AccurateGbufferNormals = false; //如果有显著效果变化则开启
        [SerializeField] public bool m_UseNativeRenderPass = true;
        [SerializeField] public RenderingMode m_RenderingMode = RenderingMode.Forward;
        ...
        internal GraphicsFormat additionalLightsCookieFormat
        {
            get
            {
                ...
                foreach (var format in UniversalRenderPipelineAsset.s_LightCookieFormatList[(int)m_AdditionalLightsCookieFormat])
                {
