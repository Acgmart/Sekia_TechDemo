...
//
///////////////////////////////////////////
Shader "miHoYo/Particles/Decal_OneTexWithEleID" {
Properties {
...
[Enum(R,0,G,1,B,2,A,3)] _BaseTexAlphaChannelToggle ("BaseTexAlphaChannelToggle", Float) = 0
...
void main()
{
    ...
    u_xlatb0.xz = equal(vec4(_BaseTexColorChannelToggle), vec4(4.0, 0.0, 5.0, 0.0)).xz;
...
""
 ...
 Pass {
  Tags { "LIGHTMODE" = "PREPASSDECALBASE" }
  ZTest GEqual
  ZWrite Off
  Cull Front
  GpuProgramID 111045
...
void main()
{
    ...
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
#endif
    u_xlat16_3.x = u_xlat16_3.x * u_xlat4.x + -0.100000001;
#ifdef UNITY_ADRENO_ES3
...
#endif
    if((int(u_xlatb0.x) * int(0xffffffffu))!=0){discard;}
    SV_Target0 = vec4(0.5, 1.0, 0.5, 0.0);
    ...
    u_xlatb0.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_ElementViewEleDrawOn);
#endif
    u_xlat16_3.z = _ElementViewEleID * 0.00392156886;
    u_xlat16_3.x = float(0.0);
    u_xlat16_3.y = float(0.0);
    SV_Target2.xyz = (u_xlatb0.x) ? u_xlat16_3.xyz : vec3(0.0, 0.0, 0.0);
    SV_Target2.w = 1.0;
    return;
}
...
void main()
{
...
#endif
    u_xlat16_4.x = u_xlat16_4.x * u_xlat5.x + -0.100000001;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_4.x<0.0);
#else
    u_xlatb0.x = u_xlat16_4.x<0.0;
#endif
    if((int(u_xlatb0.x) * int(0xffffffffu))!=0){discard;}
    ...
    u_xlatb0.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_ElementViewEleDrawOn);
#endif
    u_xlat16_4.z = _ElementViewEleID * 0.00392156886;
    u_xlat16_4.x = float(0.0);
    u_xlat16_4.y = float(0.0);
    SV_Target2.xyz = (u_xlatb0.x) ? u_xlat16_4.xyz : vec3(0.0, 0.0, 0.0);
    SV_Target2.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat4 = u_xlat4 / _VerticalFadeStart;
    u_xlat4 = max(u_xlat4, 0.00999999978);
    u_xlat4 = log2(u_xlat4);
    u_xlat4 = u_xlat4 * _VerticalFadeExp;
    ...
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
#endif
    u_xlat16_3.x = u_xlat16_3.x * u_xlat4 + -0.100000001;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_3.x<0.0);
#else
    u_xlatb0.x = u_xlat16_3.x<0.0;
...
void main()
{
    ...
    u_xlat5 = u_xlat5 / _VerticalFadeStart;
    u_xlat5 = max(u_xlat5, 0.00999999978);
    u_xlat5 = log2(u_xlat5);
    u_xlat5 = u_xlat5 * _VerticalFadeExp;
    ...
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0, 1.0);
#endif
    u_xlat16_4.x = u_xlat16_4.x * u_xlat5 + -0.100000001;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_4.x<0.0);
#else
    u_xlatb0.x = u_xlat16_4.x<0.0;
