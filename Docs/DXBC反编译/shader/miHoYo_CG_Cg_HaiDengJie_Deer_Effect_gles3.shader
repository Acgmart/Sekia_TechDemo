...
//
///////////////////////////////////////////
Shader "miHoYo/CG/Cg_HaiDengJie_Deer_Effect" {
Properties {
...
_NoiseUVchannle ("NoiseUVchannle", Range(0, 1)) = 0
_NoiseUV1Tiling ("NoiseUV1Tiling", Vector) = (1,1,0,0)
...
_Mask01_Tiling ("Mask01_Tiling", Float) = 1
_Mask02_Tiling ("Mask02_Tiling", Float) = 1
_MaskOffset ("MaskOffset", Range(0, 1)) = 0
_AlphaMask ("AlphaMask", Float) = 1
_StepMin ("StepMin", Range(0, 1)) = 0.07581266
_StepMax ("StepMax", Range(0, 1)) = 0.2705882
_Opacity ("Opacity", Float) = 1
_MaskLerp ("MaskLerp", Range(0, 1)) = 0
...
uniform 	mediump vec2 _NoiseUV1Tiling;
uniform 	mediump float _NoiseUVchannle;
uniform 	mediump float _Noise_Vspeed;
uniform 	mediump float _NoiseIntensity;
uniform 	vec4 _Mask01_ST;
uniform 	mediump float _Mask01_Tiling;
uniform 	mediump float _MaskOffset;
uniform 	vec4 _Mask02_ST;
uniform 	mediump float _Mask02_Tiling;
uniform 	mediump float _MaskLerp;
uniform 	mediump float _StepMax;
uniform 	mediump float _AlphaMask;
...
void main()
{
    ...
    u_xlat16_1.xy = vs_TEXCOORD1.xy * _NoiseUV1Tiling.xy + (-u_xlat0.xy);
    u_xlat16_1.xy = vec2(vec2(_NoiseUVchannle, _NoiseUVchannle)) * u_xlat16_1.xy + u_xlat0.xy;
    ...
    u_xlat10.xy = vs_TEXCOORD1.xy * _Mask02_ST.xy + _Mask02_ST.zw;
    u_xlat16_1.y = u_xlat10.y * _Mask02_Tiling;
    u_xlat16_11 = (-_MaskOffset) + 1.0;
    u_xlat16_1.x = u_xlat10.x * _Mask02_Tiling + u_xlat16_11;
    u_xlat16_1.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_1.xy;
    u_xlat10_10 = texture(_Mask02, u_xlat16_1.xy).x;
    u_xlat3.xy = vs_TEXCOORD0.xy * _Mask01_ST.xy + _Mask01_ST.zw;
    u_xlat16_1.x = u_xlat3.x * _Mask01_Tiling + u_xlat16_11;
    u_xlat16_1.y = u_xlat3.y * _Mask01_Tiling;
    u_xlat16_1.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_1.xy;
    u_xlat10_0.x = texture(_Mask01, u_xlat16_1.xy).x;
    u_xlat16_5 = (-u_xlat10_0.x) + u_xlat10_10;
    u_xlat0.x = _MaskLerp * u_xlat16_5 + u_xlat10_0.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb5 = !!(u_xlat0.x>=_StepMin);
#else
    u_xlatb5 = u_xlat0.x>=_StepMin;
#endif
    u_xlat16_1.x = (u_xlatb5) ? 1.0 : 0.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb5 = !!(u_xlat0.x>=_StepMax);
#else
    u_xlatb5 = u_xlat0.x>=_StepMax;
#endif
    u_xlat16_6.x = (u_xlatb5) ? -1.0 : -0.0;
    u_xlat16_1.x = u_xlat16_6.x + u_xlat16_1.x;
    u_xlat16_6.x = (-vs_TEXCOORD0.x) + 1.0;
    u_xlat16_6.x = max(u_xlat16_6.x, 9.99999975e-05);
    u_xlat16_6.x = log2(u_xlat16_6.x);
    u_xlat16_6.x = u_xlat16_6.x * _AlphaMask;
    u_xlat16_6.x = exp2(u_xlat16_6.x);
    u_xlat16_6.x = min(u_xlat16_6.x, 1.0);
    u_xlat16_6.x = u_xlat0.x * u_xlat16_6.x + u_xlat16_1.x;
    u_xlat16_0 = u_xlat16_6.x * _Opacity;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_6.x = max(vs_TEXCOORD1.x, 9.99999975e-05);
    u_xlat16_6.x = log2(u_xlat16_6.x);
    u_xlat16_6.x = u_xlat16_6.x * _ColorLerp;
    u_xlat16_6.x = exp2(u_xlat16_6.x);
    u_xlat16_6.x = u_xlat16_6.x * _ColorLerpScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_6.x = min(max(u_xlat16_6.x, 0.0), 1.0);
#else
    u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0);
#endif
    u_xlat16_2.xyz = _DarkColor.xyz * vec3(_DarkColorScale);
    u_xlat16_4.xyz = _LightColor.xyz * vec3(_LightColorScale) + (-u_xlat16_2.xyz);
    u_xlat16_6.xyz = u_xlat16_6.xxx * u_xlat16_4.xyz + u_xlat16_2.xyz;
    u_xlat16_2.xyz = (-u_xlat16_6.xyz) + _EdgeColor.xyz;
    SV_Target0.xyz = u_xlat16_1.xxx * u_xlat16_2.xyz + u_xlat16_6.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = vs_TEXCOORD0.xy * _Noise_ST.xy + _Noise_ST.zw;
    u_xlat16_2.xy = vs_TEXCOORD1.xy * _NoiseUV1Tiling.xy + (-u_xlat0.xy);
    u_xlat16_2.xy = vec2(vec2(_NoiseUVchannle, _NoiseUVchannle)) * u_xlat16_2.xy + u_xlat0.xy;
    u_xlat16_3.x = _Time.y * _Noise_Uspeed + u_xlat16_2.x;
    u_xlat16_3.y = _Time.y * _Noise_Vspeed + u_xlat16_2.y;
    u_xlat10_0.xy = texture(_Noise, u_xlat16_3.xy).xy;
    u_xlat10.xy = vs_TEXCOORD0.xy * _Mask01_ST.xy + _Mask01_ST.zw;
    u_xlat16_16 = (-_MaskOffset) + 1.0;
    u_xlat4.xy = vs_TEXCOORD1.xy * _Mask02_ST.xy + _Mask02_ST.zw;
    u_xlat16_2.y = u_xlat10.y * _Mask01_Tiling;
    u_xlat16_2.x = u_xlat10.x * _Mask01_Tiling + u_xlat16_16;
    u_xlat16_2.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_2.xy;
    u_xlat10_10 = texture(_Mask01, u_xlat16_2.xy).x;
    u_xlat16_2.y = u_xlat4.y * _Mask02_Tiling;
    u_xlat16_2.x = u_xlat4.x * _Mask02_Tiling + u_xlat16_16;
    u_xlat16_2.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_2.xy;
    u_xlat10_0.x = texture(_Mask02, u_xlat16_2.xy).x;
    u_xlat16_0 = (-u_xlat10_10) + u_xlat10_0.x;
    u_xlat0.x = _MaskLerp * u_xlat16_0 + u_xlat10_10;
#ifdef UNITY_ADRENO_ES3
    u_xlatb5 = !!(u_xlat0.x>=_StepMin);
#else
    u_xlatb5 = u_xlat0.x>=_StepMin;
    ...
    u_xlat16_1.x = u_xlat16_1.x * _AlphaMask;
    u_xlat16_1.x = exp2(u_xlat16_1.x);
    u_xlat16_1.x = min(u_xlat16_1.x, 1.0);
    u_xlat16_1.x = u_xlat0.x * u_xlat16_1.x + u_xlat16_16;
    u_xlat16_0 = u_xlat16_1.x * _Opacity;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0 = min(max(u_xlat16_0, 0.0), 1.0);
#else
    u_xlat16_0 = clamp(u_xlat16_0, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_1.x = min(u_xlat16_1.x, 1.0);
    u_xlat16_1.x = u_xlat0.x * u_xlat16_1.x + u_xlat16_16;
    u_xlat0.x = u_xlat5.x * u_xlat16_1.x;
    u_xlat0.x = u_xlat0.x * _Opacity;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.x = min(max(u_xlat0.x, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat16_6.x = min(u_xlat16_6.x, 1.0);
    u_xlat16_6.x = u_xlat0.x * u_xlat16_6.x + u_xlat16_1.x;
    u_xlat0.w = u_xlat16_6.x * _Opacity;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_2.x * _AlphaMask;
    u_xlat16_2.x = exp2(u_xlat16_2.x);
    u_xlat16_2.x = min(u_xlat16_2.x, 1.0);
    u_xlat16_16 = u_xlat0.x * u_xlat16_2.x + u_xlat16_16;
    u_xlat0.w = u_xlat16_16 * _Opacity;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.w = min(max(u_xlat0.w, 0.0), 1.0);
#else
    u_xlat0.w = clamp(u_xlat0.w, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_2.y = _Time.y * _Noise_Vspeed + u_xlat16_1.y;
    u_xlat10_0.xy = texture(_Noise, u_xlat16_2.xy).xy;
    u_xlat8.xy = vs_TEXCOORD1.xy * _Mask02_ST.xy + _Mask02_ST.zw;
    u_xlat16_1.y = u_xlat8.y * _Mask02_Tiling;
    u_xlat16_9 = (-_MaskOffset) + 1.0;
    u_xlat16_1.x = u_xlat8.x * _Mask02_Tiling + u_xlat16_9;
    u_xlat16_1.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_1.xy;
    u_xlat10_8 = texture(_Mask02, u_xlat16_1.xy).x;
    u_xlat3.xy = vs_TEXCOORD0.xy * _Mask01_ST.xy + _Mask01_ST.zw;
    u_xlat16_1.x = u_xlat3.x * _Mask01_Tiling + u_xlat16_9;
    u_xlat16_1.y = u_xlat3.y * _Mask01_Tiling;
    u_xlat16_1.xy = u_xlat10_0.xy * vec2(_NoiseIntensity) + u_xlat16_1.xy;
    u_xlat10_0.x = texture(_Mask01, u_xlat16_1.xy).x;
    u_xlat16_4 = (-u_xlat10_0.x) + u_xlat10_8;
    u_xlat0.x = _MaskLerp * u_xlat16_4 + u_xlat10_0.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(u_xlat0.x>=_StepMin);
#else
    u_xlatb4 = u_xlat0.x>=_StepMin;
#endif
    u_xlat16_1.x = (u_xlatb4) ? 1.0 : 0.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(u_xlat0.x>=_StepMax);
#else
    u_xlatb4 = u_xlat0.x>=_StepMax;
#endif
    u_xlat16_5 = (u_xlatb4) ? -1.0 : -0.0;
    u_xlat16_1.x = u_xlat16_5 + u_xlat16_1.x;
    u_xlat16_5 = (-vs_TEXCOORD0.x) + 1.0;
    u_xlat16_5 = max(u_xlat16_5, 9.99999975e-05);
    u_xlat16_5 = log2(u_xlat16_5);
    u_xlat16_5 = u_xlat16_5 * _AlphaMask;
