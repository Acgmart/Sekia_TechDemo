...
//
///////////////////////////////////////////
Shader "miHoYo/Enviro/FlashCloud" {
Properties {
_Eff_FlashCloud01 ("Eff_FlashCloud01", 2D) = "white" { }
_LightBrightness ("LightBrightness", Float) = 6.92
...
precision highp int;
uniform 	vec4 _Eff_FlashCloud01_ST;
uniform 	float _LightBrightness;
uniform lowp sampler2D _Eff_FlashCloud01;
...
void main()
{
    u_xlat0.xyz = vs_COLOR0.xyz * vec3(_LightBrightness);
    u_xlat1.xy = vs_TEXCOORD0.xy * _Eff_FlashCloud01_ST.xy + _Eff_FlashCloud01_ST.zw;
    u_xlat10_1 = texture(_Eff_FlashCloud01, u_xlat1.xy);
    u_xlat0.xyz = u_xlat10_1.www * u_xlat0.xyz + (-u_xlat10_1.xyz);
    u_xlat0.xyz = u_xlat10_1.zzz * u_xlat0.xyz + u_xlat10_1.xyz;
    u_xlat16_1 = u_xlat10_1.w * u_xlat10_1.z;
...
uniform 	vec4 _Eff_FlashCloud01_ST;
uniform 	float _LightBrightness;
struct miHoYoEnviroFlashCloudArray_Type {
	mediump vec4 _MeshParticleColorArray;
};
layout(std140) uniform UnityInstancing_miHoYoEnviroFlashCloud {
	miHoYoEnviroFlashCloudArray_Type miHoYoEnviroFlashCloudArray[UNITY_RUNTIME_INSTANCING_ARRAY_SIZE];
};
uniform lowp sampler2D _Eff_FlashCloud01;
in highp vec4 vs_COLOR0;
in highp vec4 vs_TEXCOORD0;
...
void main()
{
    ...
    u_xlat0 = vs_COLOR0 * miHoYoEnviroFlashCloudArray[u_xlati0]._MeshParticleColorArray;
    u_xlat0.xyz = u_xlat0.xyz * vec3(_LightBrightness);
    u_xlat1.xy = vs_TEXCOORD0.xy * _Eff_FlashCloud01_ST.xy + _Eff_FlashCloud01_ST.zw;
    u_xlat10_1 = texture(_Eff_FlashCloud01, u_xlat1.xy);
    u_xlat0.xyz = u_xlat10_1.www * u_xlat0.xyz + (-u_xlat10_1.xyz);
    u_xlat2.xyz = u_xlat10_1.zzz * u_xlat0.xyz + u_xlat10_1.xyz;
    u_xlat16_0 = u_xlat10_1.w * u_xlat10_1.z;
    u_xlat2.w = u_xlat16_0 * u_xlat0.w;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = vs_TEXCOORD0.xy * _Eff_FlashCloud01_ST.xy + _Eff_FlashCloud01_ST.zw;
    u_xlat10_0 = texture(_Eff_FlashCloud01, u_xlat0.xy);
    u_xlat1.xyz = vs_COLOR0.xyz * vec3(_LightBrightness);
    u_xlat1.xyz = u_xlat10_0.www * u_xlat1.xyz + (-u_xlat10_0.xyz);
    u_xlat1.xyz = u_xlat10_0.zzz * u_xlat1.xyz + u_xlat10_0.xyz;
    u_xlat16_0 = u_xlat10_0.w * u_xlat10_0.z;
...
void main()
{
    ...
    u_xlati0 = int(vs_SV_InstanceID0) + unity_BaseInstanceID;
    u_xlat3.xy = vs_TEXCOORD0.xy * _Eff_FlashCloud01_ST.xy + _Eff_FlashCloud01_ST.zw;
    u_xlat10_1 = texture(_Eff_FlashCloud01, u_xlat3.xy);
    u_xlat0 = vs_COLOR0 * miHoYoEnviroFlashCloudArray[u_xlati0]._MeshParticleColorArray;
    u_xlat0.xyz = u_xlat0.xyz * vec3(_LightBrightness);
    u_xlat0.xyz = u_xlat10_1.www * u_xlat0.xyz + (-u_xlat10_1.xyz);
    u_xlat2.xyz = u_xlat10_1.zzz * u_xlat0.xyz + u_xlat10_1.xyz;
...
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _Eff_FlashCloud01_ST.xy + _Eff_FlashCloud01_ST.zw;
    u_xlat10_0.xy = texture(_Eff_FlashCloud01, u_xlat0.xy).zw;
    u_xlat16_0 = u_xlat10_0.y * u_xlat10_0.x;
    u_xlat16_1 = vs_COLOR0.w * u_xlat16_0 + (-_MotionVectorsAlphaCutoff);
...
void main()
{
    ...
    u_xlat16_1 = u_xlat3 * u_xlat16_0 + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(u_xlat16_1<0.0);
#else
    u_xlatb0 = u_xlat16_1<0.0;
