...
//
///////////////////////////////////////////
Shader "miHoYo/Grass/LowLOD_Billboard" {
Properties {
...
void main()
{
    ...
    u_xlat16_6 = (-u_xlat16_4) + _BurnedColor;
    u_xlat10.x = _Time.y + (-unity_Builtins0Array[u_xlati31 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[1].x);
    u_xlat10.x = u_xlat10.x * _ReciprocalBurnTime;
#ifdef UNITY_ADRENO_ES3
    u_xlat10.x = min(max(u_xlat10.x, 0.0), 1.0);
#else
    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
#endif
    u_xlat20.x = fract(abs(unity_Builtins0Array[u_xlati31 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[0].x));
    u_xlat10.x = u_xlat20.x * u_xlat10.x;
    u_xlat16_4 = u_xlat10.xxxx * u_xlat16_6 + u_xlat16_4;
...
void main()
{
    ...
    u_xlat16_3 = (-u_xlat16_1) + _BurnedColor;
    u_xlat10.x = _Time.y + (-unity_Builtins0Array[u_xlati2 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[1].x);
    u_xlat10.x = u_xlat10.x * _ReciprocalBurnTime;
#ifdef UNITY_ADRENO_ES3
    u_xlat10.x = min(max(u_xlat10.x, 0.0), 1.0);
#else
    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
#endif
    u_xlat18 = fract(abs(unity_Builtins0Array[u_xlati2 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[0].x));
