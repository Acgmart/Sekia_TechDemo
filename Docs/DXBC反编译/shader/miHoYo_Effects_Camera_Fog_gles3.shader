...
//
///////////////////////////////////////////
Shader "miHoYo/Effects/Camera_Fog" {
Properties {
_MainColor ("MainColor", Color) = (1,1,1,1)
_ColorBrightness ("ColorBrightness", Range(0, 30)) = 1
_AlphaBrightness ("AlphaBrightness", Range(0, 20)) = 1
...
#endif
    u_xlat2.x = vs_COLOR0.w * _MainColor.w;
    u_xlat0.x = u_xlat0.x * u_xlat2.x;
    u_xlat0.w = u_xlat0.x * _DayColor.w;
    u_xlat1.xyz = vec3(_ColorBrightness) * _MainColor.xyz;
...
void main()
{
    u_xlat0.xyz = vs_TEXCOORD6.zxy / vs_TEXCOORD6.www;
    u_xlat0.x = u_xlat0.x * 0.5 + 0.5;
    u_xlat2.x = texture(_CameraDepthTextureScaled, u_xlat0.yz).x;
    u_xlat0.x = u_xlat0.x * _ProjectionParams.z;
    u_xlat0.x = u_xlat2.x * _ProjectionParams.z + (-u_xlat0.x);
    u_xlat0.x = u_xlat0.x / _Length;
    u_xlat2.xyz = (-vs_TEXCOORD5.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat2.x = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat2.x = sqrt(u_xlat2.x);
...
void main()
{
    ...
    u_xlat0.xyz = vs_TEXCOORD6.zxy / vs_TEXCOORD6.www;
    u_xlat0.x = u_xlat0.x * 0.5 + 0.5;
    u_xlat3.x = texture(_CameraDepthTexture, u_xlat0.yz).x;
...
void main()
{
    ...
    u_xlat0.xyz = vs_TEXCOORD6.zxy / vs_TEXCOORD6.www;
    u_xlat0.x = u_xlat0.x * 0.5 + 0.5;
    u_xlat3.x = texture(_CameraDepthTextureScaled, u_xlat0.yz).x;
    u_xlat0.x = u_xlat0.x * _ProjectionParams.z;
    u_xlat0.x = u_xlat3.x * _ProjectionParams.z + (-u_xlat0.x);
    u_xlat0.x = u_xlat0.x / _Length;
    u_xlat3.xyz = vec3(_ColorBrightness) * _MainColor.xyz;
    u_xlat3.xyz = u_xlat3.xyz * vs_COLOR0.xyz;
    u_xlat1.xyz = u_xlat3.xyz * _DayColor.xyz;
...
void main()
{
    ...
    vs_TEXCOORD5.xyz = unity_Builtins0Array[u_xlati3 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat0.xzw;
    vs_TEXCOORD5.w = 0.0;
    u_xlat0.x = u_xlat2.y * _ProjectionParams.x;
    u_xlat0.w = u_xlat0.x * 0.5;
    u_xlat0.xz = u_xlat2.xw * vec2(0.5, 0.5);
