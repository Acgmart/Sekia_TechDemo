...
//
///////////////////////////////////////////
Shader "miHoYo/Particles/Distortion" {
Properties {
...
void main()
{
    u_xlat0.xyz = vs_TEXCOORD3.www * vs_COLOR0.xyz + vs_TEXCOORD3.xyz;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _DistortionMask_ST.xy + _DistortionMask_ST.zw;
    u_xlat0 = texture(_DistortionMask, u_xlat0.xy);
    ...
    u_xlat3 = (u_xlatb1.y) ? u_xlat0.y : u_xlat6;
...
{
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!((-_MotionVectorsAlphaCutoff)<0.0);
#else
    u_xlatb0 = (-_MotionVectorsAlphaCutoff)<0.0;
#endif
