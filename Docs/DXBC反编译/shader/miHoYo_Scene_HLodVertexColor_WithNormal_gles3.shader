...
//
///////////////////////////////////////////
Shader "miHoYo/Scene/HLodVertexColor_WithNormal" {
Properties {
...
void main()
{
    ...
    u_xlat0.z = vs_TEXCOORD6.z;
    u_xlat1.z = vs_TEXCOORD5.x;
    u_xlat1.x = vs_TEXCOORD4.x;
    u_xlat1.y = vs_TEXCOORD6.x;
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat1.yzx;
    u_xlat16_2.xyz = u_xlat0.zxy * u_xlat1.zxy + (-u_xlat16_2.xyz);
    u_xlat3.x = vs_TEXCOORD6.y;
    u_xlat3.y = vs_TEXCOORD5.y;
    u_xlat3.z = vs_TEXCOORD4.y;
    u_xlat16_4.xyz = u_xlat0.zxy * u_xlat3.yzx;
    u_xlat16_4.xyz = u_xlat3.xyz * u_xlat0.xyz + (-u_xlat16_4.xyz);
    u_xlat16_20 = dot(u_xlat1.xyz, u_xlat16_4.xyz);
    u_xlat16_20 = float(1.0) / u_xlat16_20;
    u_xlat16_2.xyz = vec3(u_xlat16_20) * u_xlat16_2.xyz;
    u_xlat0.xy = vs_TEXCOORD3.xy * _StoneNormal_ST.xy + _StoneNormal_ST.zw;
    u_xlat10_0.xyz = texture(_StoneNormal, u_xlat0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat16_0.w = 1.0;
    u_xlat16_2.y = dot(u_xlat16_2.xyz, u_xlat16_0.xyw);
    u_xlat16_5.xyz = u_xlat1.zxy * u_xlat3.xyz;
    u_xlat16_5.xyz = u_xlat1.yzx * u_xlat3.yzx + (-u_xlat16_5.xyz);
    u_xlat16_5.xyz = vec3(u_xlat16_20) * u_xlat16_5.xyz;
    u_xlat16_4.xyz = vec3(u_xlat16_20) * u_xlat16_4.xyz;
    u_xlat16_2.x = dot(u_xlat16_4.xyz, u_xlat16_0.xyw);
    u_xlat16_2.z = dot(u_xlat16_5.xyz, u_xlat16_0.xyw);
    u_xlat1.xyz = u_xlat16_0.zzz * vs_COLOR0.xyz;
    ...
    SV_Target2.z = (u_xlatb1) ? u_xlat16_2.x : 0.0;
