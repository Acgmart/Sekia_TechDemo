...
//
///////////////////////////////////////////
Shader "miHoYo/Effects/Rainbow_SoftAdd" {
Properties {
_Rainbow ("Rainbow", 2D) = "white" { }
_MainColor ("MainColor", Color) = (0,0,0,0)
_EndFadeValue ("EndFadeValue", Float) = 192.98
...
uniform 	vec4 _Rainbow_ST;
uniform 	float _EndFadeValue;
uniform 	mediump float _AlphaBrightness;
uniform lowp sampler2D _Rainbow;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _Rainbow_ST.xy + _Rainbow_ST.zw;
    u_xlat0.z = (-u_xlat0.x) + 1.0;
    u_xlat4.xy = u_xlat0.zx * u_xlat0.zx;
    u_xlat10_1 = texture(_Rainbow, u_xlat0.xy);
    u_xlat1 = u_xlat10_1 * _MainColor;
    u_xlat0.x = u_xlat4.x * u_xlat4.y;
    u_xlat0.x = u_xlat0.x * _EndFadeValue;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _Rainbow_ST.xy + _Rainbow_ST.zw;
    u_xlat0.z = (-u_xlat0.x) + 1.0;
    u_xlat6.xy = u_xlat0.zx * u_xlat0.zx;
    u_xlat10_0 = texture(_Rainbow, u_xlat0.xy).w;
    u_xlat0.x = u_xlat10_0 * _MainColor.w;
    u_xlat3 = u_xlat6.x * u_xlat6.y;
    u_xlat3 = u_xlat3 * _EndFadeValue;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_1 = u_xlat0.x * _AlphaBrightness + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
