...
//
///////////////////////////////////////////
Shader "miHoYo/UI/Gacha_Skybox" {
Properties {
_LightColor01 ("LightColor01", Color) = (0.426273,0.3749459,0.6985294,0)
_DarkColor01 ("DarkColor01", Color) = (0.1609537,0.07028547,0.1911765,0)
_Power ("Power", Float) = 3.05
_Scale ("Scale", Float) = 2.17
...
precision highp int;
uniform 	vec4 _DarkColor01;
uniform 	vec4 _LightColor01;
...
void main()
{
    ...
    u_xlat6 = inversesqrt(u_xlat6);
    u_xlat1.xyz = vec3(u_xlat6) * vs_TEXCOORD5.xyz;
...
#endif
    u_xlat2.xyz = (-_DarkColor01.xyz) + _LightColor01.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat2.xyz + _DarkColor01.xyz;
    u_xlat0.w = _Opacity;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    u_xlat16_0 = (-_MotionVectorsAlphaCutoff) + _Opacity;
#ifdef UNITY_ADRENO_ES3
