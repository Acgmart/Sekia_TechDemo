...
//
///////////////////////////////////////////
Shader "miHoYo/Effects/Dissolve_BaseMask" {
Properties {
_DayColor ("DayColor", Color) = (1,1,1,1)
_FadeMain ("FadeMain", Range(0, 1)) = 1
_MainColor ("MainColor", Color) = (1,1,1,1)
_ColorScale ("ColorScale", Float) = 2
_MaskTex ("MaskTex", 2D) = "white" { }
_MaskChannelNum ("MaskChannelNum", Range(0, 4)) = 1
_MaskPanner ("MaskPanner", Vector) = (0,0,0,0)
_MaskScale ("MaskScale", Float) = 1
_DissloveTex ("DissloveTex", 2D) = "white" { }
_DissolveTex_UVXY ("DissolveTex_UV(XY)", Vector) = (0,0,0,0)
_DissloveChannelNum ("DissloveChannelNum", Range(0, 4)) = 1
_DissolveAni ("DissolveAni", Range(0, 1)) = 1
_DissolveHardScale ("DissolveHardScale", Float) = 10
...
uniform 	mediump float _LerpColorScale;
uniform 	mediump vec2 _DissolveTex_UVXY;
uniform 	vec4 _DissloveTex_ST;
uniform 	mediump float _DissloveChannelNum;
uniform 	mediump float _DissolveHardScale;
uniform 	mediump float _DissolveAni;
uniform 	mediump float _SetLerpColor;
uniform 	mediump float _FadeMain;
uniform 	mediump vec2 _MaskPanner;
...
void main()
{
    ...
    u_xlat0.xy = _Time.yy * vec2(_MaskPanner.x, _MaskPanner.y) + u_xlat0.xy;
    ...
    u_xlat16_2 = (-vec4(_DissloveChannelNum)) + vec4(1.0, 2.0, 3.0, 4.0);
    ...
    u_xlat16_2.x = min(abs(_DissloveChannelNum), 1.0);
    u_xlat16_2.x = (-u_xlat16_2.x) + 1.0;
    u_xlat16_4.x = u_xlat16_4.x + u_xlat16_2.x;
    u_xlat16_2.x = _DayColor.w * _MainColor.w;
    u_xlat8 = u_xlat16_2.x * vs_COLOR0.w;
    u_xlat16_2.x = (-u_xlat8) * _DissolveAni + 1.0;
    u_xlat16_6 = -1.0 / _DissolveHardScale;
    u_xlat16_10 = (-u_xlat16_6) + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_10 + u_xlat16_6;
    u_xlat16_4.x = u_xlat16_4.x + (-u_xlat16_2.x);
    u_xlat16_4.x = u_xlat16_4.x * _DissolveHardScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_4.x = min(max(u_xlat16_4.x, 0.0), 1.0);
#else
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0, 1.0);
#endif
    u_xlat16_2.x = u_xlat16_4.x * _FadeMain;
    u_xlat16_6 = u_xlat16_4.x * _SetLerpColor;
    u_xlat0.w = u_xlat16_0.x * u_xlat16_2.x;
    u_xlat16_2.xzw = vec3(_ColorScale) * _MainColor.xyz;
    u_xlat16_3.xyz = _LerpColor.xyz * vec3(_LerpColorScale) + (-u_xlat16_2.xzw);
...
void main()
{
    ...
    u_xlat0.w = u_xlat4.x * u_xlat16_0.x;
    u_xlat16_2.xzw = vec3(_ColorScale) * _MainColor.xyz;
    u_xlat16_3.xyz = _LerpColor.xyz * vec3(_LerpColorScale) + (-u_xlat16_2.xzw);
    u_xlat16_2.xyz = vec3(u_xlat16_6) * u_xlat16_3.xyz + u_xlat16_2.xzw;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _DayColor.xyz;
...
void main()
{
    ...
    u_xlat16_1 = (-vec4(_DissloveChannelNum)) + vec4(1.0, 2.0, 3.0, 4.0);
    u_xlat16_1 = min(abs(u_xlat16_1), vec4(1.0, 1.0, 1.0, 1.0));
    u_xlat16_1 = (-u_xlat16_1) + vec4(1.0, 1.0, 1.0, 1.0);
    u_xlat16_2.x = min(abs(_DissloveChannelNum), 1.0);
    u_xlat16_7 = _DayColor.w * _MainColor.w;
    u_xlat3 = u_xlat16_7 * vs_COLOR0.w;
    u_xlat16_2.y = -1.0 / _DissolveHardScale;
    u_xlat16_12 = (-u_xlat3) * _DissolveAni + 1.0;
    u_xlat16_2.xw = (-u_xlat16_2.xy) + vec2(1.0, 1.0);
    u_xlat16_7 = u_xlat16_12 * u_xlat16_2.w + u_xlat16_2.y;
    u_xlat16_0.xy = u_xlat10_0.xy * u_xlat16_1.xy;
    u_xlat16_0.x = u_xlat16_0.y + u_xlat16_0.x;
    u_xlat16_0.x = u_xlat10_0.z * u_xlat16_1.z + u_xlat16_0.x;
    u_xlat16_0.x = u_xlat10_0.w * u_xlat16_1.w + u_xlat16_0.x;
    ...
    u_xlat16_0.x = u_xlat16_0.x * _DissolveHardScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0.x = min(max(u_xlat16_0.x, 0.0), 1.0);
#else
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    u_xlat16_1.x = u_xlat16_0.x * _SetLerpColor;
    u_xlat16_6.xyz = vec3(_ColorScale) * _MainColor.xyz;
    u_xlat16_2.xyz = _LerpColor.xyz * vec3(_LerpColorScale) + (-u_xlat16_6.xyz);
    u_xlat16_1.xyz = u_xlat16_1.xxx * u_xlat16_2.xyz + u_xlat16_6.xyz;
    u_xlat5.xy = vs_TEXCOORD0.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
    u_xlat5.xy = _Time.yy * vec2(_MaskPanner.x, _MaskPanner.y) + u_xlat5.xy;
    u_xlat10_2 = texture(_MaskTex, u_xlat5.xy);
    ...
    u_xlat16_16 = min(abs(_MaskChannelNum), 1.0);
    u_xlat16_16 = (-u_xlat16_16) + 1.0;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _DayColor.xyz;
    u_xlat4.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz;
    u_xlat16_1.x = u_xlat16_0.x * _FadeMain;
    ...
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    u_xlat4.w = u_xlat16_0.x * u_xlat16_1.x;
    SV_Target0 = u_xlat4;
    return;
}
...
void main()
{
    ...
    u_xlat4.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz;
    u_xlat16_1.x = u_xlat16_0.x * _FadeMain;
    u_xlat16_0.xz = u_xlat10_2.xy * u_xlat16_3.xy;
...
#endif
    u_xlat16_0.x = u_xlat16_0.x * u_xlat16_1.x;
    u_xlat4.w = u_xlat5.x * u_xlat16_0.x;
    SV_Target0 = u_xlat4;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    u_xlat5.xy = vs_TEXCOORD0.xy * _DissloveTex_ST.xy + _DissloveTex_ST.zw;
    u_xlat5.xy = _Time.yy * vec2(_DissolveTex_UVXY.x, _DissolveTex_UVXY.y) + u_xlat5.xy;
    u_xlat10_1 = texture(_DissloveTex, u_xlat5.xy);
    u_xlat16_2 = (-vec4(_DissloveChannelNum)) + vec4(1.0, 2.0, 3.0, 4.0);
    u_xlat16_2 = min(abs(u_xlat16_2), vec4(1.0, 1.0, 1.0, 1.0));
    u_xlat16_2 = (-u_xlat16_2) + vec4(1.0, 1.0, 1.0, 1.0);
    ...
    u_xlat16_2.x = _DayColor.w * _MainColor.w;
    u_xlat10 = u_xlat16_2.x * vs_COLOR0.w;
    u_xlat16_2.x = (-u_xlat10) * _DissolveAni + 1.0;
    u_xlat16_7 = -1.0 / _DissolveHardScale;
    u_xlat16_12 = (-u_xlat16_7) + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_12 + u_xlat16_7;
    u_xlat16_5.x = u_xlat16_5.x + (-u_xlat16_2.x);
    u_xlat16_5.x = u_xlat16_5.x * _DissolveHardScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_5.x = min(max(u_xlat16_5.x, 0.0), 1.0);
#else
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
#endif
    u_xlat16_2.x = u_xlat16_5.x * _FadeMain;
    u_xlat16_7 = u_xlat16_5.x * _SetLerpColor;
    u_xlat0.w = u_xlat16_0.x * u_xlat16_2.x;
    u_xlat16_2.xzw = vec3(_ColorScale) * _MainColor.xyz;
    u_xlat16_3.xyz = _LerpColor.xyz * vec3(_LerpColorScale) + (-u_xlat16_2.xzw);
    u_xlat16_2.xyz = vec3(u_xlat16_7) * u_xlat16_3.xyz + u_xlat16_2.xzw;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _DayColor.xyz;
    u_xlat4.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz;
    u_xlat0.xyz = vs_TEXCOORD3.www * u_xlat4.xyz + vs_TEXCOORD3.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat0.w = u_xlat5.x * u_xlat16_0.x;
    u_xlat16_2.xzw = vec3(_ColorScale) * _MainColor.xyz;
    u_xlat16_3.xyz = _LerpColor.xyz * vec3(_LerpColorScale) + (-u_xlat16_2.xzw);
    u_xlat16_2.xyz = vec3(u_xlat16_7) * u_xlat16_3.xyz + u_xlat16_2.xzw;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _DayColor.xyz;
...
void main()
{
    ...
    u_xlat16_16 = (-u_xlat16_16) + 1.0;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _DayColor.xyz;
    u_xlat5.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz;
    u_xlat16_1.x = u_xlat16_0.x * _FadeMain;
    ...
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    u_xlat1.w = u_xlat16_0.x * u_xlat16_1.x;
...
void main()
{
    ...
    u_xlat16_0.x = u_xlat10_0.z * u_xlat16_1.z + u_xlat16_0.x;
    u_xlat16_0.x = u_xlat10_0.w * u_xlat16_1.w + u_xlat16_0.x;
    u_xlat16_1.x = min(abs(_DissloveChannelNum), 1.0);
    u_xlat16_1.x = (-u_xlat16_1.x) + 1.0;
    u_xlat16_0.x = u_xlat16_0.x + u_xlat16_1.x;
    u_xlat16_1.x = _DayColor.w * _MainColor.w;
    u_xlat4 = u_xlat16_1.x * vs_COLOR0.w;
    u_xlat16_1.x = (-u_xlat4) * _DissolveAni + 1.0;
    u_xlat16_5 = -1.0 / _DissolveHardScale;
    ...
    u_xlat16_5 = min(abs(_MaskChannelNum), 1.0);
    ...
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
#endif
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_0.x + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_0.x = u_xlat16_0.x + u_xlat16_1.x;
    u_xlat16_1.x = _DayColor.w * _MainColor.w;
    u_xlat4.x = u_xlat16_1.x * vs_COLOR0.w;
    u_xlat16_1.x = (-u_xlat4.x) * _DissolveAni + 1.0;
    u_xlat16_5 = -1.0 / _DissolveHardScale;
    u_xlat16_9 = (-u_xlat16_5) + 1.0;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_9 + u_xlat16_5;
    u_xlat16_0.x = u_xlat16_0.x + (-u_xlat16_1.x);
    ...
    u_xlat16_1.x = u_xlat16_0.x * u_xlat4.x + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(u_xlat16_1.x<0.0);
#else
    u_xlatb0 = u_xlat16_1.x<0.0;
