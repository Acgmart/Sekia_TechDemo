...
//
///////////////////////////////////////////
Shader "miHoYo/Effects/ClothPiece_VertexAni" {
Properties {
_DayColor ("DayColor", Color) = (1,1,1,1)
_MainColor ("MainColor", Color) = (1,1,1,1)
_ColorBrightness ("ColorBrightness", Float) = 1
_AlphaBrightness ("AlphaBrightness", Float) = 1
_ClothTex ("ClothTex", 2D) = "white" { }
_MaskTex ("MaskTex", 2D) = "white" { }
_MaskR_ShapeScale ("MaskR_ShapeScale", Float) = 1
_MaskG_DissolveScale ("MaskG_DissolveScale", Float) = 1
...
void main()
{
    u_xlat16_0 = in_TEXCOORD0.y * -2.0 + 1.0;
    u_xlat16_0 = _VMaskFlip * u_xlat16_0 + in_TEXCOORD0.y;
    u_xlat16_0 = u_xlat16_0 + (-_VMaskOffset);
    u_xlat16_0 = max(u_xlat16_0, 9.99999975e-05);
    u_xlat16_0 = log2(u_xlat16_0);
    u_xlat16_0 = u_xlat16_0 * _VMaskThreshold;
    u_xlat16_0 = exp2(u_xlat16_0);
    u_xlat16_0 = min(u_xlat16_0, 1.0);
    u_xlat16_4.x = (-u_xlat16_0) + in_COLOR0.w;
    u_xlat16_0 = _VertexColorAMaskDisplace * u_xlat16_4.x + u_xlat16_0;
    ...
    u_xlat2.xyz = vec3(u_xlat16_0) * u_xlat16_4.xyz + in_POSITION0.xyz;
...
uniform 	vec4 _ClothTex_ST;
uniform 	vec4 _MaskTex_ST;
uniform 	mediump float _MaskG_DissolveScale;
uniform 	float _AlphaBrightness;
uniform 	mediump float _MaskR_ShapeScale;
uniform lowp sampler2D _ClothTex;
...
void main()
{
    ...
    u_xlat16_1 = (-u_xlat0.x) * _AlphaBrightness + 1.0;
    u_xlat16_5 = -1.0 / _MaskG_DissolveScale;
    u_xlat16_9 = (-u_xlat16_5) + 1.0;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_9 + u_xlat16_5;
    u_xlat0.xy = vs_TEXCOORD0.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
    u_xlat10_0.xy = texture(_MaskTex, u_xlat0.xy).xy;
    u_xlat16_4 = (-u_xlat16_1) + u_xlat10_0.y;
    u_xlat16_0 = u_xlat10_0.x * _MaskR_ShapeScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0 = min(max(u_xlat16_0, 0.0), 1.0);
#else
    u_xlat16_0 = clamp(u_xlat16_0, 0.0, 1.0);
#endif
    u_xlat16_4 = u_xlat16_4 * _MaskG_DissolveScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_4 = min(max(u_xlat16_4, 0.0), 1.0);
#else
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
#endif
    u_xlat0.w = u_xlat16_0 * u_xlat16_4;
    ...
    u_xlat3.xy = vs_TEXCOORD0.xy * _ClothTex_ST.xy + _ClothTex_ST.zw;
    u_xlat10_3.xyz = texture(_ClothTex, u_xlat3.xy).xyz;
    u_xlat0.xyz = u_xlat2.xyz * u_xlat10_3.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0 = exp2(u_xlat16_0);
    u_xlat16_0 = min(u_xlat16_0, 1.0);
    u_xlat16_5.x = (-u_xlat16_0) + in_COLOR0.w;
    u_xlat16_0 = _VertexColorAMaskDisplace * u_xlat16_5.x + u_xlat16_0;
    ...
    u_xlat7.xyz = vec3(u_xlat16_0) * u_xlat16_5.xyz + in_POSITION0.xyz;
...
void main()
{
    ...
    u_xlat0.xy = vs_TEXCOORD0.xy * _ClothTex_ST.xy + _ClothTex_ST.zw;
    ...
    u_xlat16_2 = -1.0 / _MaskG_DissolveScale;
    u_xlat16_6 = (-u_xlat1.x) * _AlphaBrightness + 1.0;
    u_xlat16_10 = (-u_xlat16_2) + 1.0;
    u_xlat16_2 = u_xlat16_6 * u_xlat16_10 + u_xlat16_2;
    u_xlat1.xyz = vs_COLOR0.xyz * vec3(_ColorBrightness);
    u_xlat1.xyz = u_xlat1.xyz * _MainColor.xyz;
    u_xlat1.xyz = u_xlat1.xyz * _DayColor.xyz;
    u_xlat10_3.xyz = texture(_ClothTex, u_xlat0.xy).xyz;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat10_3.xyz;
    u_xlat10_0.xy = texture(_MaskTex, u_xlat8.xy).xy;
    u_xlat16_4 = (-u_xlat16_2) + u_xlat10_0.y;
    u_xlat16_4 = u_xlat16_4 * _MaskG_DissolveScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_4 = min(max(u_xlat16_4, 0.0), 1.0);
#else
    ...
    u_xlat16_0 = clamp(u_xlat16_0, 0.0, 1.0);
#endif
    u_xlat1.w = u_xlat16_0 * u_xlat16_4;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = _Time.yy * vec2(_OffsetValueXYSpeedZ.z, _OffsetValueXYSpeedZ.z) + u_xlat0.xy;
    ...
    u_xlat16_1.x = (-_OffsetValueXYSpeedZ.xxyz.y) + _OffsetValueXYSpeedZ.xxyz.z;
    u_xlat16_1.x = u_xlat0.x * u_xlat16_1.x + _OffsetValueXYSpeedZ.xxyz.y;
    u_xlat16_1.xyz = u_xlat16_1.xxx * _WPS_DisplaceScale.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * in_NORMAL0.xyz;
    u_xlat16_10 = in_TEXCOORD0.y * -2.0 + 1.0;
    u_xlat16_10 = _VMaskFlip * u_xlat16_10 + in_TEXCOORD0.y;
    u_xlat16_10 = u_xlat16_10 + (-_VMaskOffset);
    u_xlat16_10 = max(u_xlat16_10, 9.99999975e-05);
    u_xlat16_10 = log2(u_xlat16_10);
    u_xlat16_10 = u_xlat16_10 * _VMaskThreshold;
    u_xlat16_10 = exp2(u_xlat16_10);
    u_xlat16_10 = min(u_xlat16_10, 1.0);
    u_xlat16_2 = (-u_xlat16_10) + in_COLOR0.w;
    u_xlat16_10 = _VertexColorAMaskDisplace * u_xlat16_2 + u_xlat16_10;
...
void main()
{
    ...
    u_xlat5.xy = _Time.yy * vec2(_OffsetValueXYSpeedZ.z, _OffsetValueXYSpeedZ.z) + u_xlat5.xy;
    ...
    u_xlat16_4.x = (-_OffsetValueXYSpeedZ.xxyz.y) + _OffsetValueXYSpeedZ.xxyz.z;
    u_xlat16_4.x = u_xlat5.x * u_xlat16_4.x + _OffsetValueXYSpeedZ.xxyz.y;
    u_xlat16_4.xyz = u_xlat16_4.xxx * _WPS_DisplaceScale.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * in_NORMAL0.xyz;
    u_xlat5.xyz = vec3(u_xlat16_0) * u_xlat16_4.xyz + in_POSITION0.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_5.xxx * _WPS_DisplaceScale.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * in_NORMAL0.xyz;
    u_xlat2.xyz = vec3(u_xlat16_0) * u_xlat16_5.xyz + in_POSITION0.xyz;
    u_xlat0 = u_xlat2.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[0] * u_xlat2.xxxx + u_xlat0;
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[2] * u_xlat2.zzzz + u_xlat0;
    u_xlat0 = u_xlat0 + hlslcc_mtx4x4unity_ObjectToWorld[3];
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * _MainColor.w;
    u_xlat16_1 = (-u_xlat0.x) * _AlphaBrightness + 1.0;
    u_xlat16_4 = -1.0 / _MaskG_DissolveScale;
    u_xlat16_7 = (-u_xlat16_4) + 1.0;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_7 + u_xlat16_4;
    u_xlat0.xy = vs_TEXCOORD0.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
    u_xlat10_0.xy = texture(_MaskTex, u_xlat0.xy).xy;
    u_xlat16_3 = (-u_xlat16_1) + u_xlat10_0.y;
    u_xlat16_0 = u_xlat10_0.x * _MaskR_ShapeScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_0 = min(max(u_xlat16_0, 0.0), 1.0);
#else
    u_xlat16_0 = clamp(u_xlat16_0, 0.0, 1.0);
#endif
    u_xlat16_3 = u_xlat16_3 * _MaskG_DissolveScale;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_3 = min(max(u_xlat16_3, 0.0), 1.0);
#else
    u_xlat16_3 = clamp(u_xlat16_3, 0.0, 1.0);
#endif
    u_xlat16_1 = u_xlat16_3 * u_xlat16_0 + (-_MotionVectorsAlphaCutoff);
#ifdef UNITY_ADRENO_ES3
