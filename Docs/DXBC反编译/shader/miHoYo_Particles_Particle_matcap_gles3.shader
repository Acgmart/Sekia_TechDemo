...
//
///////////////////////////////////////////
Shader "miHoYo/Particles/Particle_matcap" {
Properties {
...
void main()
{
    ...
    u_xlat3.xy = vs_TEXCOORD3.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
    ...
    SV_Target1 = u_xlat0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb21 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_ElementViewEleDrawOn));
#else
    u_xlatb21 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_ElementViewEleDrawOn);
#endif
    u_xlat16_4.x = _ElementViewEleID * 0.00392156886;
    SV_Target2.z = (u_xlatb21) ? u_xlat16_4.x : u_xlat0.z;
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat0.xyz * vec3(0.5, 0.5, 0.5) + vec3(0.5, 0.5, 0.5);
    SV_Target0.w = 0.00392156886;
    u_xlat0.x = vs_TEXCOORD3.y * _GradientRange + _GradientOffset;
#ifdef UNITY_ADRENO_ES3
