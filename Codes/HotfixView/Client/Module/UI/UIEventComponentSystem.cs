    ...
    public static class UIEventComponentSystem
    {
        public class UIEventComponentAwakeSystem : AwakeSystem<UIEventComponent>
        {
            protected override void Awake(UIEventComponent self)
            {
                ...
                //添加UI的Root
                GRoot.inst.SetContentScaleFactor(960, 540, UIContentScaler.ScreenMatchMode.MatchWidthOrHeight);
                ...
                //初始化UI包名
                UIPackageConfig uiPackageConfig = CodeLoader.Instance.UIPackageConfig;
                foreach (var package in uiPackageConfig.uIPackages)
                {
