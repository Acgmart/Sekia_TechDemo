...
namespace FairyGUI
{
    ...
    public class GRoot : GComponent
    {
        ...
        {
            //Debug.LogError($"设置缩放 舞台宽{Stage.inst.width} 舞台高{Stage.inst.height}");
            //Debug.LogError($"设置缩放 Size{Stage.inst.width / UIContentScaler.scaleFactor} {Stage.inst.height / UIContentScaler.scaleFactor}");
            //Debug.LogError($"设置缩放 Scale{UIContentScaler.scaleFactor} {UIContentScaler.scaleFactor}");
