...
namespace UnityEditor.Formats.Fbx.Exporter
{
    ...
    public sealed class ModelExporter : System.IDisposable
    {
        ...
        /// </summary>
        public const string ChangeLogPath = "Packages/com.unity.formats.fbx/CHANGELOG.md";
        ...
        /// </summary>
        [SecurityPermission(SecurityAction.LinkDemand)]
        public bool ExportInstance(GameObject unityGo, FbxScene fbxScene, FbxNode fbxNode)
        {
            if (!unityGo || fbxNode == null)
            {
                return false;
        ...
        /// </summary>
        public bool ExportCamera(GameObject unityGO, FbxScene fbxScene, FbxNode fbxNode)
        {
        ...
        /// Cookie => Gobo
        /// </summary>
        public bool ExportLight(GameObject unityGo, FbxScene fbxScene, FbxNode fbxNode)
        {
            if (!unityGo || fbxScene == null || fbxNode == null)
            {
                return false;
        ...
        /// </summary>
        [SecurityPermission(SecurityAction.LinkDemand)]
        public bool ExportComponents(FbxScene fbxScene)
        {
        ...
        public void ReplaceMetafile(string metafilePath)
        {
            // get relative path
            var fbxPath = "Assets/" + ExportSettings.ConvertToAssetRelativePath(m_lastFilePath);
            if (AssetDatabase.LoadAssetAtPath(fbxPath, typeof(Object)) == null)
        ...
        /// </summary>
        public static Dictionary<System.Type, GetMeshForComponent> MeshForComponentCallbacks
        ...
        public static List<GetMeshForObject> MeshForObjectCallbacks = new List<GetMeshForObject>();
        ...
        /// </summary>
        [SecurityPermission(SecurityAction.LinkDemand)]
        public bool ExportMesh(GameObject gameObject, FbxNode fbxNode)
        {
        ...
        public string m_tempFilePath { get; set; }
        public string m_lastFilePath { get; set; }
